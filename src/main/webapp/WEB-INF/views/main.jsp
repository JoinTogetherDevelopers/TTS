                            ...
                            <table class="table table-striped">
                                ...
                                <c:forEach var="project" items="${totalProject}">
                                    <tr>
                                        ...
                                        <td><a href="/project/${project.projectKey}">${project.projectKey}</a></td>
                                        <td><a href="/project/${project.addressId}">${project.projectName}</a></td>
                            ...
                            <table class="table table-striped">
                                ...
                                <c:choose>
                                    <c:when test="${fn:length(myProject) < 1}">
                                        <tr>
                                            <td colspan="5" style="text-align: center"><span>권한을 가진 프로젝트가 없습니다.</span>
                                            </td>
                                        </tr>
                                    </c:when>
                                    <c:otherwise>
                                        <c:forEach var="project" items="${myProject}">
                                            <tr>
                                                <td class="text-center">${project.sequence} </td>
                                                <td><a href="/project/${project.addressId}">${project.projectKey}</a>
                                                </td>
                                                <td><a href="/project/${project.addressId}">${project.projectName}</a></td>
                                                <td>${project.managerId} </td>
