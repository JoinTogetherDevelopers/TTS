...
public class HomeController {
	...
	/*
	 * @RequestMapping(value = "/kcmsus", method = RequestMethod.GET) public
	 * String kcmsus(Locale locale, Model model) { log.info("프로젝트 home 진입");
	 * 
	 * return "projectMain"; }
	 */
	...
	public ModelAndView openJobTemplateDetail() {
		...
		/*
		 * String columnNames = null; String columnData = null;
		 * 
		 * try { columnNames = activityBO.getColumnNames(); columnData =
		 * activityBO.getColumnData(); } catch (Exception e) { log.error("test",
		 * e); }
		 * 
